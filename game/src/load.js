...
var loadState = {
  preload: function () {
    ...
    game.load.image("connect_button", "assets/ui/connect_button.png");
    game.load.image("register_button", "assets/ui/register_button.png");
